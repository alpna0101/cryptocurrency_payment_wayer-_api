		...
		<div class="container">
			<div class="row">
				...
				<aside class="col-xs-6 text-right">
					<ul>
						<li><a href="{{URL::to('/')}}/create_account">Create Account</a></li>
...
@endif
						<div class="ryt_innerlink">
							...
							<form method='post' id='login' class='login'  action="{{asset('login')}}">
					            {{csrf_field()}}
							...
							<h5 class="text-center"><a href="{{URL::to('/')}}/create_account">Create Account</a></h5>
