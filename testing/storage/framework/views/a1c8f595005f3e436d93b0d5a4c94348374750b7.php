<?php /* /var/www/html/wyer/testing/resources/views/preview_payment.blade.php */ ?>
<?php echo $__env->make('layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<aside class="col-sm-6 account_info">
				 ...
				 <a href ="<?php echo e(URL::to('/')); ?>/blockchain?id=<?php echo e($_GET['id']); ?>" > <input type="button" value="Attach Blockchain Payout Address"  class="btn  text-uppercase orange_btn"></a>
				  </p>
