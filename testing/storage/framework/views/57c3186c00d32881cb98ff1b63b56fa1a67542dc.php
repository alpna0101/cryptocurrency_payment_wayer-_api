<?php /* /var/www/html/wyer/testing/resources/views/layout/header.blade.php */ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<div class="container">
			<div class="row">
				...
				<aside class="col-xs-8 text-right">
					<ul>
						<li><a href="<?php echo e(URL::to('/')); ?>/preview_account">My Account</a></li>
						<li><a href="<?php echo URL::to('/')."/preview_payment?id=".$payment_id ?>">Blockchain Payout Method</a></li>
					<li><a href="<?php echo e(URL::to('/')); ?>/create_transfer">Create Transfer</a></li>
					<li><a href="<?php echo e(URL::to('/')); ?>/transfer">Transfer History</a></li>
