<?php /* /var/www/html/wyer/testing/resources/views/signup.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<nav class="navbar navbar_link_heder">
	  <div class="container">
		<div class="navbar-header">
		  <a class="navbar-brand" href="index.html"><img src="<?php echo e(asset('public')); ?>/images/logo.png"></a>
		</div>
		<div class="alrdy_accunt pull-right">
			<p><span>Already have an Account?</span><a href="<?php echo e(url('login')); ?>">LOGIN</a></p>
		</div>
	  </div>
	</nav>
</section>
	...
	<div class="container">
		<div class="col-md-10 col-md-offset-1">
			<div class="inner_linkouter">
				...
				<form method='post' id='signup' class='signup' enctype='multipart/form-data' action="<?php echo e(asset('createProfile')); ?>">
