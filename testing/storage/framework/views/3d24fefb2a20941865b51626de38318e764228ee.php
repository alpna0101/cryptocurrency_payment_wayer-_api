<?php /* /var/www/html/wyer/testing/resources/views/preview_account.blade.php */ ?>
...
<section class="form_outer">
			<div class="container">
				...
				<div class="white_box">
				 ...
				 <a href ="<?php echo e(URL::to('/')); ?>/payment"> <input type="button" value="Add Payment"  class="btn btn-block text-uppercase orange_btn"></a>
				  </aside>
                    </div>
					<div class="row">
						...
						<aside class="col-sm-6">
							<div class="balance_area">
								...
								<div class="box_balance">
									<h3><img src="<?php echo e(asset('public')); ?>/images/bitcoin_icon.png">BTC</h3>
									<p class="btc">0.0000000</p>
								</div>
								<div class="box_balance">
									<h3><img src="<?php echo e(asset('public')); ?>/images/eth_icon.png" alt="" />ETH</h3>
									<p class="eth">0.0</p>
								</div>
							</div>
